...
function preload ()
{
    ...
    this.load.image('star', 'assets/lego.png');
...
this.physics.add.collider(player, bombs, hitBomb, null, this);
        ...
        bombText = this.add.text(600, 16, 'bomb: 0', { fontSize: '32px', fill: '#000' });
...
function collectStar (player, star)
{
    ...
    if (stars.countActive(true) === 0)
    {
        ...
        bombCompteur += 1;
        bombText.setText('bomb: ' + bombCompteur);
    }
}
...
function hitBomb (player, bomb)
{
    ...
    gameOverText = this.add.text(160, 300, 'GAME OVER', { fontSize: '100px', fill: '#ff0000' });
